# Generate a history suppliers report from the configured Octopus dossier.
#
# Returns historical supplier data for the specified period and bookyear range.
#
module Tools
  class ReportHistorySuppliers
    extend OctopusAuth
    ...
    def self.call(params:, context:)
      ...
      with_dossier_connection(context) do |client|
        result = client.report_history_suppliers(query_data)
