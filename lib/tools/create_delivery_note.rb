# Create a delivery note in the configured Octopus dossier.
#
# Creates a new delivery note with the specified details. Similar structure to
  ...
  class CreateDeliveryNote
    ...
    def self.call(params:, context:)
      ...
      with_dossier_connection(context) do |client|
        result = client.create_delivery_note(delivery_note_data)
        {
          status: "created",
